            ...
            <main>
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="<?= base_url(); ?>pasien" class="btn btn-primary">All</a>
                            <a href="<?= base_url(); ?>print_pasien/cetak" class="btn btn-primary">Cetak</a>
                        </div>
                    </div>
                    <div class="card mb-4">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url(); ?>pasien/detail/<?= $pasien['id_pasien']; ?>" class="badge badge-primary float-right">Detail</a>
                                                </td>
                                                <td>
                                                    <a href="<?= base_url(); ?>pasien/edit/<?= $pasien['id_pasien']; ?>" class="badge badge-success float-right">Edit </a>
                                                </td>
                                                <td>
                                                    <a href="<?= base_url(); ?>pasien/hapus/<?= $pasien['id_pasien']; ?>" class="badge badge-danger float-right" onclick="return confirm('Yakin Data ini akan dihapus?')">Hapus</a>
                                                    <!-- </li> -->
                                                </td>
