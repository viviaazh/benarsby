...
<body>
    ...
    <div class="container text-center" style="margin-top: 10vh">
        ...
        <h1 class="display-3">Maaf, anda tidak dapat input tiket</h1>
        <p class="lead"><strong> karena sudah pernah menginput tiket hari ini, Silakan Download dan Cetak Nomor Antrian Anda Sebelumnya</strong>
            <!-- <span id="time"></span> -->
        </p>
        <hr>
        <p class="lead">
            <a class="btn btn-success btn-lg" target="_blank" href="<?php echo site_url('cetak/proseslama') ?>" role="button">Cetak</a>
        </p>
        <p class="lead">
